/* V9.3.1 — cleaned operational runtime + Digital Factory phase 2. */
(function(){
'use strict';
const BUILD='V9.3.1';
...
async function loadOperationalExtensions(){
  await waitForBase();
  await loadScriptOnce('production-set-delete-authority-v9.js?v=9.3.1','data-vu-production-set-delete');
  await loadScriptOnce('painting-full-order-authority-v9.js?v=9.3.1','data-vu-paint-full-order');
  await loadScriptOnce('order-update-recalc-authority-v9.js?v=9.3.1','data-vu-order-recalc');
  await loadScriptOnce('worksheet-paint-reconciliation-authority-v9.js?v=9.3.1','data-vu-paint-reconcile');
  await loadScriptOnce('order-identity-reconciliation-v9.js?v=9.3.1','data-vu-order-identity');
  await loadScriptOnce('partial-dispatch-capture-v9.js?v=9.3.1','data-vu-partial-dispatch');
  await loadScriptOnce('dispatch-stepper-authority-v9.js?v=9.3.1','data-vu-dispatch-stepper');
  await loadScriptOnce('live-factory-pack-authority-v9.js?v=9.3.1','data-vu-live-pack');
  await loadScriptOnce('digital-factory-v93.js?v=9.3.1','data-vu-digital-factory');
  await loadScriptOnce('digital-factory-role-shell-v93.js?v=9.3.1','data-vu-digital-factory-role-shell');
  applyBuildLabel();
  window.dispatchEvent(new CustomEvent('vu:operational-authorities-ready',{detail:{build:BUILD}}));
}
applyBuildLabel();
loadOperationalExtensions().catch(e=>console.error('V9.3.1 operational authority load failed',e));
window.VUApplyBuildLabel=applyBuildLabel;
window.VUOperationalBuild={version:'9.3.1',ready:()=>String(window.VUPaintingFullOrderAuthority?.version||'')==='9.1.05'&&String(window.VUPartialDispatchCapture?.version||'')==='9.1.14'&&String(window.VUOrderIdentityReconciliation?.version||'')==='9.2.0'&&!!window.VULiveFactoryPackAuthority&&String(window.VUWorksheetPaintReconciliationAuthority?.version||'')==='9.1.12'&&!!window.VUDispatchStepperAuthority&&!!window.VUProductionSetDeleteAuthority&&!!window.VUOrderUpdateRecalcAuthority&&String(window.VUDigitalFactory?.version||'')==='9.3.0'&&String(window.VUDigitalFactoryRoleShell?.version||'')==='9.3.1'};
})();