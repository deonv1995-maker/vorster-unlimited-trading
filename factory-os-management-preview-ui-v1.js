...
const previewRoute=r=>r==='Casting'?'manufacturing-casting':r==='Packing'?'manufacturing-packing':r==='Resin'?'manufacturing-resin':r==='Painting'?'painting':r==='Delivery'?'deliveries':'dashboard';
...
window.VUManagementPreviewUI={version:'1.0.2',render,previewRoute};
})();